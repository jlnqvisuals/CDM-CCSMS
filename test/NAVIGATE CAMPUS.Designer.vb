...
Partial Class NAVIGATE_CAMPUS
    ...
    Private Sub InitializeComponent()
        ...
        adminBldgBtn.Text = "ADMIN BLDG"
        adminBldgBtn.UseVisualStyleBackColor = True
        ' 
        ' prrcBldgBtn
        ' 
        ...
        prrcBldgBtn.Text = "PRRC BLDG"
        prrcBldgBtn.UseVisualStyleBackColor = True
        ' 
        ' newBldgBtn
        ' 
        ...
        newBldgBtn.Text = "NEW BLDG"
        newBldgBtn.UseVisualStyleBackColor = True
        ' 
        ' adminBldgPanel
        ' 
        ...
        ' adminBackBtn
        ' 
        adminBackBtn.Location = New Point(249, 425)
        ...
        Label3.Location = New Point(15, 162)
        Label3.Name = "Label3"
        Label3.Size = New Size(240, 32)
        Label3.TabIndex = 0
        Label3.Text = "Total Room Count: ??"
        ' 
        ' Label2
        ' 
